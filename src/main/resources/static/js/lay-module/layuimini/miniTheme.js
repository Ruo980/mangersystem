        ...
        listen: function (options) {
            $('body').on('click', '[data-bgcolor]', function () {
                ...
                var html = '<div class="layuimini-color">\n' +
                    ...
                    '<a class="more-menu-item" href="http://www.baice.net.cn/index.html" target="_blank"><i class="layui-icon layui-icon-theme"></i> 官方网站</a>\n' +
                    '<a class="more-menu-item" href="https://aiqicha.baidu.com/company_detail_28721161990511?rq=es&pd=ee&from=ps" target="_blank"><i class="layui-icon layui-icon-tabs" style="font-size: 16px;"></i> 企业信息</a>\n' +
                    '<a class="more-menu-item" href="https://baike.baidu.com/item/%E7%99%BE%E7%AD%96%EF%BC%88%E5%8C%97%E4%BA%AC%EF%BC%89%E7%A7%91%E6%8A%80%E6%9C%89%E9%99%90%E5%85%AC%E5%8F%B8/14679324?fr=aladdin" target="_blank"><i class="layui-icon layui-icon-read" style="font-size: 19px;"></i> 百度词条</a>\n' +
                    '</div>' +
                    '</div>';
                layer.open({
                    type: 1,
